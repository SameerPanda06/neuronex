    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 pb-3 border-b border-[#131E35]">
      ...
      <div>
        <div className="flex items-center gap-2">
          <div className="p-1 rounded bg-[#0D1830] border border-amber-500/30 text-amber-400">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded bg-[#2B1B0A] text-amber-300 border border-amber-500/30">
              Selective ARQ
            </span>
          </div>
        </div>
        <p className="text-xs text-slate-400 font-normal mt-0.5">
          Automatic repeat-request protocol for selective packet recovery
        </p>
      </div>
